...
class CustomAdapter(private val stockList: List<StockPrice>):
    ...
    override fun onBindViewHolder(viewholder: ViewHolder, i: Int) {
        ...
        viewholder.itemNombreAccion.text = stock.date
        viewholder.itemValorAccion.text = stock.volume.toString()
